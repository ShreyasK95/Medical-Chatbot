/*REPLACE THE ABOVE GOOGLE AI API KEY BY CREATING YOUR OWN API KEY FROM THE GIVEN WEBSITE 
...
def map_click():
    ...
    user_query_from_click = response1.split("appears to be")[1]  # Or some extracted part
    cursor.execute("INSERT INTO chat_history (user_query, bot_response) VALUES (?, ?)",
